(function() {
    ...
    const STATIC_MATERIALS = {
        ...
        teacher: [
            ...
            { name: "1. Как защитить детей от поисковых систем", url: "https://disk.yandex.ru/i/CoZcEixgoJmCmQ", type: "brochure" },
            { name: "2. Как определить опасные сообщества в сети", url: "https://disk.yandex.ru/i/zAUpFkFxfcAFLA", type: "brochure" },
            { name: "3. Как победить компьютерные вирусы", url: "https://disk.yandex.ru/i/8Q0nB6h-ydLyBg", type: "brochure" },
            { name: "4. Как подать жалобу на вредный контент в сети", url: "https://disk.yandex.ru/i/XU5ImRRY5tYmRA", type: "brochure" },
            { name: "5. Как совершать покупки в сети", url: "https://disk.yandex.ru/i/kVbORx6WfUyOIw", type: "brochure" },
            { name: "6. Как создать надежный пароль", url: "https://disk.yandex.ru/i/GfyxlMnNQG71bg", type: "brochure" },
            { name: "7. Какие киберугрозы существуют", url: "https://disk.yandex.ru/i/Vkk3_HL9Pl9LjA", type: "brochure" },
            { name: "8. Мошенники в сети как обезопаситься", url: "https://disk.yandex.ru/i/UilXWqQcqaK77A", type: "brochure" },
            { name: "9. Мошенничество с банковскими картами как себя обезопасить", url: "https://disk.yandex.ru/i/KokX2r-DgDnsig", type: "brochure" },
            { name: "10. Почему нельзя обмениваться интимными фото в интернете", url: "https://disk.yandex.ru/i/kgObbQvqIqaR-g", type: "brochure" },
            { name: "11. Что нельзя делать в сети", url: "https://disk.yandex.ru/i/Dk-Wq-Cuh1XEjQ", type: "brochure" },
            { name: "12. Что относиться к персональным данным", url: "https://disk.yandex.ru/i/RfsMbT2S_qrfOw", type: "brochure" },
            { name: "13. Что такое фейк", url: "https://disk.yandex.ru/i/dE-uwzqGW8t7pg", type: "brochure" }
        ],
        official: [
